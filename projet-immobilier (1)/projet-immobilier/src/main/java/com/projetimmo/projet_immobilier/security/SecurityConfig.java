...
public class SecurityConfig {
        ...
        @Value("${cors.allowed-origins:http://localhost:3000,http://127.0.0.1:3000,http://localhost:3001,http://127.0.0.1:3001,http://192.168.*.*:3000,http://10.*.*.*:3000,http://172.16.*.*:3000,http://172.17.*.*:3000,http://172.18.*.*:3000,http://172.19.*.*:3000,http://172.2*.*.*:3000,http://172.30.*.*:3000,http://172.31.*.*:3000}")
        ...
        public CorsConfigurationSource corsConfigurationSource() {
                ...
                // Origines autorisées (patterns pour supporter IP LAN mobile)
